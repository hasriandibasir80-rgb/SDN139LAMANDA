...
export const konfigurasiFitur = {
  'layanan-portal': [
    ...
    {
      nama: 'SIMACCA',
      icon: '💼', // Icon briefcase untuk sistem manajemen
      link: 'https://script.google.com/macros/s/AKfycbzEGn4yvaS19zKiUaU_ymgPsiXeHkxYr4Rxr5HTyAYdwPIrDYQujrnV0t2sEB-wT_3fcw/exec',
      isExternal: true
    }
  ],
