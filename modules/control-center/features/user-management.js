...
function renderPermissions(container) {
  ...
  permissionsContainer.innerHTML = AVAILABLE_MODULES.map(module => `<div class="um-permission-module"> <div class="um-permission-module-header"> <input type="checkbox" id="perm-${module.id}" data-module="${module.id}"> <label for="perm-${module.id}">${module.icon} ${module.name}</label> </div> <div class="um-permission-submodules"> ${module.subModules.map(sub => `<div class="um-permission-submodule"> <input type="checkbox" id="perm-${sub.id}" data-module="${module.id}" data-sub="${sub.id}"> <label for="perm-${sub.id}">${sub.icon} ${sub.name}</label> </div>`).join('')} </div> </div>`).join('');
...
// =========================================
// LOAD USERS (Updated: schools/{NPSN}/users)
// =========================================
...
// =========================================
// SAVE USER (Updated: schools/{NPSN}/users)
// =========================================
...
// =========================================
// EDIT USER (Updated: schools/{NPSN}/users)
// =========================================
...
// =========================================
// DELETE USER (Updated: schools/{NPSN}/users)
// =========================================
